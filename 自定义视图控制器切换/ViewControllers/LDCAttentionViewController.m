...
- (void)setStep{
    [super setStep];
    self.navigationItem.leftBarButtonItem = [UIBarButtonItem barButtonItemWith:@"friendsRecommentIcon" selecImage:@"friendsRecommentIcon-click" target:self selector:nil];
}
